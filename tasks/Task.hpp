#ifndef PIPELINE_DETECTOR_TASK_TASK_HPP
#define PIPELINE_DETECTOR_TASK_TASK_HPP

#include <stddef.h>
#include "offshore_pipeline_detector/TaskBase.hpp"
#include <frame_helper/FrameHelper.h>

namespace offshore_pipeline_detector{
    ...
    public:
         ...
         */
        Task(std::string const& name = "offshore_pipeline_detector::Task");
